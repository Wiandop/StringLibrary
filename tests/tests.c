...
errors test_myStrcmp() {
    ...
    if (myStrcmp(wrong_string, test_string2) != -1) {
        return failed;
    }

    // Test second NULL value
    if (myStrcmp(test_string1, wrong_string) != -1) {
        return failed;
    }
...
errors test_myStrcpy() {
    ...
    // Test first NULL value
    if (myStrcpy(wrong_string, target_string, sizeof(test_string), sizeof(target_string)) != NULL) {
        return failed;
    }

    // Test second NULL value
    if (myStrcpy(test_string, wrong_string, sizeof(test_string), sizeof(target_string)) != NULL) {
        return failed;
    }
...
errors test_myStrdup() {
    ...
    // Program performance test
    if (myStrcmp(res, myStrdup(test_string)) != 0) {
        return failed;
    }
...
errors test_myStrstr() {
    ...
    // Test second NULL value
    if (myStrstr(test_string, wrong_string) != NULL) {
        return failed;
    }
...
errors test_myMemcpy() {
    ...
    // Test second NULL value
    if (myMemcpy(test_string, wrong_string, 5) != NULL) {
        return failed;
    }
