...
void output(char* str1, char* str2, char* str3, char* str4, size_t str1_len, size_t str3_len, char searching_symbol) {
        // Output myStrcpm()
    if (myStrcmp(str1, "Linux Ubuntu") != 0) {
        printf("Strings don't match. \n");
    } else if (myStrcmp(str1, "Linux Ubuntu") == -1) {
        printf("Invalid value passed in the string. \n");
    } else {
    ...
    } else if (myStrcpy(str1, str3, str1_len, str3_len) == -1) {
        printf("Invalid value passed in the string. \n");
    } else {
    ...
    } else if (myStrchr(str1, searching_symbol) == -1) {
        printf("Invalid value passed in the string. \n");
    } else {
    ...
    if (myMemchr(str1, searching_symbol, myStrlen(str1)) == NULL) {
        printf("Symbol '%c' not found. \n", searching_symbol);
    } else if (myMemchr(str1, searching_symbol, myStrlen(str1)) == -1) {
        printf("Invalid value passed in the string. \n");
    } else {
    ...
    } else if (myMemcpy(str1, str4, 5) == -1) {
        printf("Invalid value passed in the string. \n");
    } else {
