...
errors test_myStrcpy() {
    ...
    if (myStrcpy(wrong_string, target_string1, sizeof(test_string1), sizeof(target_string1)) != -1) {
        return failed;
    }
...
errors test_myStrstr() {
    ...
    if (myStrstr(wrong_string, target_string1) != -1) {
        return failed;
    }
...
errors test_myMemchr() {
    ...
    if (myMemchr(wrong_string, 'c', myStrlen(test_string)) != -1) {
        return failed;
    }
...
errors test_myMemcpy() {
    ...
    if (myMemcpy(wrong_string, target_string, 5) != -1) {
        return failed;
    }
